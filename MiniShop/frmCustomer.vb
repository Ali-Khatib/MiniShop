...
Public Class frmCustomer
    ...
    Private Sub getMaster_FillData()
        ...
        Sql = "SELECT * from tblCustomer where [CustomerID] ='" & CustomerID_TextEdit.EditValue & "'  "
        ...
        DA_Master.Fill(DS_Master, "tblCustomer")
        BS_Master.DataSource = DS_Master.Tables("tblCustomer")
        BN_Master.BindingSource = BS_Master

        If (Is_Master_FirstFill = False) Then

            Me.CustomerID_TextEdit.DataBindings.Add(New Binding("EditValue", Me.BS_Master, "CustomerID", True))
            Me.CustomerName_TextEdit.DataBindings.Add(New Binding("EditValue", Me.BS_Master, "CustomerName", True))


            Me.CustomerAddress_TextEdit.DataBindings.Add(New Binding("EditValue", Me.BS_Master, "CustomerAddress", True))
            Me.CustomerPhone_TextEdit.DataBindings.Add(New Binding("EditValue", Me.BS_Master, "CustomerPhone", True))
            Me.CityID_SearchLookUpEdit.DataBindings.Add(New Binding("EditValue", Me.BS_Master, "CityID", True))
            Me.CustomerMobile_TextEdit.DataBindings.Add(New Binding("EditValue", Me.BS_Master, "CustomerMobile", True))


            Me.CustomerEmail_TextEdit.DataBindings.Add(New Binding("EditValue", Me.BS_Master, "CustomerEmail", True))
        ...
        If CustomerID_TextEdit.Text = Nothing Then
            ...
            Try
                ...
                'CustomerID_TextEdit.EditValue = strCustomerID
    ...
    Private Function getMaster_SaveData() As Boolean
        ...
        If CustomerName_TextEdit.Text = Nothing Then
            MessageBox.Show("Please insert Customer name", "Save", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Return False
        End If
        ...
        Try
            ...
            If CustomerID_TextEdit.Text = Nothing Then
                ...
                CustomerID_TextEdit.EditValue = getMax_ID_SQL("tblCustomer", "CustomerID", "")
            Else
            ...
            Me.Validate()
            BS_Master.EndEdit()
            DA_Master.Update(DS_Master.Tables("tblCustomer"))
    ...
    Private Sub getDetails_FillData1()
        ...
        Sql = "SELECT  ROW_NUMBER() OVER (ORDER BY [CustomerID]) AS [#],* from tblCustomer  where isNull(RecordIsDeleted,0)=0 "
        ...
        DA_Details1.Fill(DS_Details1, "tblCustomer")
        BS_Details1.DataSource = DS_Details1.Tables("tblCustomer")
    ...
    Private Sub GV_Details1_RowClick(sender As Object, e As DevExpress.XtraGrid.Views.Grid.RowClickEventArgs) Handles GV_Details1.RowClick
        If GV_Details1.RowCount > 0 Then
            ...
            If Not RW Is Nothing Then
                CustomerID_TextEdit.EditValue = RW("CustomerID")
                getMaster_FillData()
            End If
        End If
    End Sub
    ...
    Private Sub btnNew_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnNew.ItemClick
        CustomerID_TextEdit.EditValue = Nothing
        getMaster_FillData()
    End Sub

    Private Sub btnDelete_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnDelete.ItemClick
        If MessageBox.Show("Are you sure you want to delete this Customer?", "Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = DialogResult.Yes Then

            Dim RW As DataRow = GV_Details1.GetDataRow(GV_Details1.FocusedRowHandle)
            If Not RW Is Nothing Then

                Sql = "Update tblCustomer set RecordIsDeleted='" & 1 & "',RecordDeleteDate=getdate() where CustomerID='" & RW("CustomerID") & "'"
