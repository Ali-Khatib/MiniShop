...
Public Class frmCity
    ...
    Private Sub getDetails_FillData1()
        ...
        Sql = "SELECT  ROW_NUMBER() OVER (ORDER BY [CityID]) AS [#],* from tblCity   "
        ...
        DA_Details1.Fill(DS_Details1, "tblCity")
        BS_Details1.DataSource = DS_Details1.Tables("tblCity")
    ...
    Private Sub getSave_Details1()
        ...
        Try
            ...
            Me.Validate()
            BS_Details1.EndEdit()
            DA_Details1.Update(DS_Details1.Tables("tblCity"))
