...
Partial Class frmVoucherStatus
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmVoucherStatus))
        ...
        Me.colVoucherStatusName = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.colVoucherStatusID = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        Me.GV_Details1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colVoucherStatusName, Me.colVoucherStatusID, Me.colRW_No})
        ...
        '
        'colVoucherStatusName
        '
        Me.colVoucherStatusName.Caption = "Voucher Status "
        Me.colVoucherStatusName.FieldName = "Status"
        Me.colVoucherStatusName.MinWidth = 25
        Me.colVoucherStatusName.Name = "colVoucherStatusName"
        Me.colVoucherStatusName.Visible = True
        Me.colVoucherStatusName.VisibleIndex = 1
        Me.colVoucherStatusName.Width = 398
        '
        'colVoucherStatusID
        '
        Me.colVoucherStatusID.Caption = "ID"
        Me.colVoucherStatusID.FieldName = "VoucherStatusID"
        Me.colVoucherStatusID.MinWidth = 25
        Me.colVoucherStatusID.Name = "colVoucherStatusID"
        Me.colVoucherStatusID.OptionsColumn.AllowEdit = False
        Me.colVoucherStatusID.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "EmpID", "{0}")})
        Me.colVoucherStatusID.Visible = True
        Me.colVoucherStatusID.VisibleIndex = 0
        Me.colVoucherStatusID.Width = 101
        '
        'colRW_No
        '
        Me.colRW_No.Caption = "#"
        ...
        Me.Name = "frmVoucherStatus"
        Me.Ribbon = Me.RibbonControl
        Me.StatusBar = Me.RibbonStatusBar
        Me.Text = "VoucherStatus"
    ...
    Friend WithEvents colVoucherStatusName As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents colVoucherStatusID As DevExpress.XtraGrid.Columns.GridColumn
