...
Partial Class frmPosition
    ...
    Private Sub InitializeComponent()
        ...
        Me.GV_Details1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colPositionName, Me.colPositionID, Me.colRW_No})
        ...
        'colPositionName
        '
        Me.colPositionName.Caption = "Position Name"
        Me.colPositionName.FieldName = "PositionName"
        Me.colPositionName.MinWidth = 25
        Me.colPositionName.Name = "colPositionName"
        Me.colPositionName.Visible = True
        Me.colPositionName.VisibleIndex = 1
        Me.colPositionName.Width = 398
        '
        'colPositionID
        '
        Me.colPositionID.Caption = "ID"
        Me.colPositionID.FieldName = "PositionID"
        Me.colPositionID.MinWidth = 25
        Me.colPositionID.Name = "colPositionID"
        Me.colPositionID.OptionsColumn.AllowEdit = False
        Me.colPositionID.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "EmpID", "{0}")})
        Me.colPositionID.Visible = True
        Me.colPositionID.VisibleIndex = 0
        Me.colPositionID.Width = 101
        '
        'colRW_No
        '
        Me.colRW_No.Caption = "#"
