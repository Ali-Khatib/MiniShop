...
Public Class frmVoucherStatus
    ...
    Private Sub frmVoucherStatus_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        getForm_Load()
    End Sub
    ...
    Private Sub getDetails_FillData1()
        ...
        Sql = "SELECT  ROW_NUMBER() OVER (ORDER BY [VoucherStatusID]) AS [#],* from tblVoucherStatus   "
        ...
        DA_Details1.Fill(DS_Details1, "tblVoucherStatus")
        BS_Details1.DataSource = DS_Details1.Tables("tblVoucherStatus")
    ...
    Private Sub getSave_Details1()
        ...
        Try
            ...
            Me.Validate()
            BS_Details1.EndEdit()
            DA_Details1.Update(DS_Details1.Tables("tblVoucherStatus"))
