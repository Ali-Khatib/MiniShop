...
Partial Class frmCity
    ...
    Private Sub InitializeComponent()
        ...
        Me.GV_Details1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colCityName, Me.colCityID, Me.colRW_No})
        ...
        'colCityName
        '
        Me.colCityName.Caption = "City Name"
        Me.colCityName.FieldName = "CityName"
        Me.colCityName.MinWidth = 25
        Me.colCityName.Name = "colCityName"
        Me.colCityName.Visible = True
        Me.colCityName.VisibleIndex = 1
        Me.colCityName.Width = 398
        '
        'colCityID
        '
        Me.colCityID.Caption = "ID"
        Me.colCityID.FieldName = "CityID"
        Me.colCityID.MinWidth = 25
        Me.colCityID.Name = "colCityID"
        Me.colCityID.OptionsColumn.AllowEdit = False
        Me.colCityID.Summary.AddRange(New DevExpress.XtraGrid.GridSummaryItem() {New DevExpress.XtraGrid.GridColumnSummaryItem(DevExpress.Data.SummaryItemType.Count, "EmpID", "{0}")})
        Me.colCityID.Visible = True
        Me.colCityID.VisibleIndex = 0
        Me.colCityID.Width = 101
        '
        'colRW_No
        '
        Me.colRW_No.Caption = "#"
