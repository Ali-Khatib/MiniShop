...
Public Class frmCategory
    ...
    Private Sub getDetails_FillData1()
        ...
        Sql = "SELECT  ROW_NUMBER() OVER (ORDER BY [CategoryID]) AS [#],* from tblCategory   "
        ...
        DA_Details1.Fill(DS_Details1, "tblCategory")
        BS_Details1.DataSource = DS_Details1.Tables("tblCategory")
    ...
    Private Sub getSave_Details1()
        ...
        Try
            ...
            Me.Validate()
            BS_Details1.EndEdit()
            DA_Details1.Update(DS_Details1.Tables("tblCategory"))
